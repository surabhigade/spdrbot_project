...
All the environments are registered in the `spdrbot_project` extension. They start
...
import spdrbot_project.tasks  # noqa: F401


def main():
    """Print all environments registered in `spdrbot_project` extension."""
